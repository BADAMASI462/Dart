...
void main(){
  ...
  String reversed = reverse.toString(); //STRING VARIABLE TO STORE AFTER CHANGING SPLITTED VARIABLE TO STRING
...
print('Your reversed string is: $Revname'); // DISPLAY OUTPUT OF REVERSED STRING
}